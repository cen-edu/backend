 ...
 */
final class StudentDisplayOrder {

    private StudentDisplayOrder() {
    }

    /** 학생 ID를 이름 기준으로 세운 순서. */
    static List<Long> order(Collection<Long> studentIds, Map<Long, String> namesByStudentId) {
     ...
     */
    static Map<Long, Integer> numbers(Collection<Long> rosterStudentIds,
