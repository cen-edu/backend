...
public class SafeSvgSanitizer {
    ...
    public String sanitize(String svg) {
        ...
        try {
            ...
            var allowedAttrs=java.util.Set.of("xmlns","viewBox","x","y","x1","y1","x2","y2","width","height","fill","stroke","stroke-width","points","d","font-size","text-anchor","transform","id","marker-end","marker-start");
