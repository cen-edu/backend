...
public class ProblemEditPromptFactory {
    ...
    public String create(ProblemEditAgentPayload payload) {
        ...
        return """
                ...
                schemaVersion은 1이다. problemEditResult 아래에 action, instructionDeltas, assistantMessage를 둔다.
                ...
                현재 문맥:
                sessionId=%d, baseVersionId=%d, interactionStatus=%s, selectedTarget=%s
                ...
                payload.selectedTarget(), snapshot.metadata().questionType(),
